<div class="fragment" id="nav-launch"></div>
<br /><br />
<div class="textbox">
	...
	<div class="text-separator"></div>
	<div class="fragment" id="nav-launch-steam"></div>
	...
	<div class="text-separator"></div>
	<div class="fragment" id="nav-launch-humble"></div>
	...
	<div class="text-separator"></div>
	<div class="fragment" id="nav-launch-jolt"></div>
	...
	<div class="text-separator"></div>
	<div class="fragment" id="nav-launch-itch"></div>
