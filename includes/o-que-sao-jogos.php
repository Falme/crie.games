...
<div class="textbox">
    ...
    <p>
        <li>
            <b>Antagônico:</b> Normalmente jogos contém um vencedor e um perdedor, considerando que um empate irá criar uma nova partida até que esse conflito se resolva.
        </li>
    </p>
    <p>
        <li>
            <b>Livre:</b> É uma atividade não séria, voluntária, você nunca deve ser obrigado a jogar um jogo.
        </li>
    </p>
    <p>
        <li>
            <b>Recreativa:</b> É separada da vida real, representa algo ordinário que se opôe ao trabalho e ofício. Não é algo sério.
        </li>
    </p>
    <p>
        <li>
            <b>Incerto:</b> Deve ter um desequilíbrio e assim não saber os resultados antes de jogar o jogo, caso contrário, não há motivos pra jogar se já sabe como irá terminar. 
        </li>
    </p>
    <p>
        <li>
            <b>Regrado:</b> Existem regras que devem ser seguidas por todos os participantes, essas não são as regras da vida real, são regras exclusivas do jogo que deve ser respeitado enquanto o jogo acontece.
        </li>
    </p>
    <p>
        <li>
            <b>Fictícia:</b> Contém um conflito artificial, jogos criam problemas que não causam nenhum tipo de dano na vida real, os únicos afetados são os personagens não reais do Faz-De-Conta chamado jogo.
        </li>
    </p>
    <p>
        <li>
