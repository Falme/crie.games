...
<div class="textbox">
    ...
    <div class="text-separator"></div>
    <br /><br />
    <img src="assets/images/twitch_splash.jpg" /> <br /><br />
    <a href="https://www.twitch.tv/" target="_blank" rel="noopener noreferrer">Twitch</a> Tem sido a base da receitas de estúdios. Serve como uma ótima maneira de interagir com a comunidade, uma fonte de receita e uma propaganda interativa em tempo real do trabalho que realizamos. <br /><br />
    ...
    <div class="text-separator"></div>
    <br /><br />
    <img src="assets/images/publisher_splash.jpg" /> <br /><br />
    Sempre que estiver pensando em contratar uma publicadora, tenha apenas uma pergunta em mente: Será que a ajuda da publicadora conduzirá a lucros superiores e além ao corte de receitas? Se você não sabe a resposta ou se a resposta for não, então você não precisa de uma publicadora. Se você pode lançar seu jogo sem uma publicadora, então você absolutamente deveria não contratar uma publicadora. <br /><br />
    No geral, maioria das publicadoras pedem por 30%-70% da receita do seu jogo. Esse custo vem carregado de uma época triássica, dos dias onde as publicadoras manuseavam cartuchos físicos nas prateleiras das lojas de varejo. Não precisamos mais disso devido à distribuição digital como Steam, Humble Bundle, etc. <br /><br /><br />
    <div id="nav-finance-kick"></div>
    <br />
    <div class="text-separator"></div>
    <br />
    <h3>Kickstarter</h3>
