...
<div class="textbox">
    ...
    <p>
        A forma como iniciamos esse processo foi configurando contas sociais para ajudar a reunir todas as pessoas em um só lugar. Estabelecemos o Discord como o principal centro comunitário que permitiu às pessoas um lugar comum para se encontrarem e se misturarem. Em seguida, configuramos contas satélite para direcionar as pessoas de volta ao Discord. Isso inclui coisas como <?php href("Twitter", "https://twitter.com/"); ?>, <?php href("Instagram", "https://www.instagram.com/"); ?>, <?php href("Steam", "https://store.steampowered.com/"); ?>, <?php href("Game Jolt", "https://gamejolt.com/"); ?>, <?php href("Itch.io", "https://itch.io/"); ?>, <?php href("Twitch", "https://twitch.tv"); ?>, <?php href("YouTube", "https://www.youtube.com/"); ?>, <?php href("Reddit", "https://www.reddit.com/"); ?>, e <?php href("Guilded", "https://guilded.gg/"); ?>. Esse efeito de funil aumentou nosso Discord para mais de 4.000 membros e mantém todos na mesma página para que as atualizações não sejam perdidas pelos jogadores mais engajados.
    </p>
    <p>
